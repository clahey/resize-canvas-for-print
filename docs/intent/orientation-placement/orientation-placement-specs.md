...
- [x] **RCFP-ORIENT-005**: If the two candidate orientations' crop_loss totals differ, then the system shall select the orientation with the lower crop_loss total.
